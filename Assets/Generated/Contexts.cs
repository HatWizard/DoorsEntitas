...
public partial class Contexts {
    ...
    public void InitializeEntityIndices() {
        game.AddEntityIndex(new Entitas.EntityIndex<GameEntity, string>(
            SceneId,
            game.GetGroup(GameMatcher.SceneId),
            (e, c) => ((SceneIdComponent)c).Id));
    }
}

public static class ContextsExtensions {

    public static System.Collections.Generic.HashSet<GameEntity> GetEntitiesWithSceneId(this GameContext context, string Id) {
        return ((Entitas.EntityIndex<GameEntity, string>)context.GetEntityIndex(Contexts.SceneId)).GetEntities(Id);
    }
}
//------------------------------------------------------------------------------
// <auto-generated>
